...
namespace thronefall.tower.upgrade.customizer.Towers
{
    ...
    class Tower
    {
        public class NewTowerUpgrade {
            ...
            public NewTowerUpgrade(string upgradeName, uint newHpChange = 0, int newAdditionalArrowsToShoot = -1, float newDamageMulti = 0f, float newRangeMulti = 0f, float newAttackCooldownMulti = 0f, float newProjectileSpeedMulti = 0f, float newSlowDuration = 0f) {
